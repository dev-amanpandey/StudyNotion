    ...
    <tr>
      <td align="center" style="padding: 30px 10px;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="max-width:600px; border-radius:8px; overflow:hidden;">
          ...
          <!-- Header -->
          <tr>
            <td align="center" bgcolor="#dc2626" style="padding: 30px; color:#ffffff;">
          ...
          <tr>
            <td style="padding: 30px; color:#333333; line-height:1.6;">
              ...
              <h2 style="margin-top:0; color:#dc2626;">Hello {{Student_Name}},</h2>
              ...
              <p style="word-break: break-all; font-size:14px; color:#dc2626;">
                {{Reset_Link}}
              </p>

              <p>
                This link will expire in <strong>{{Expiry_Time}}</strong> for security reasons.
              </p>
          ...
          <tr>
            <td align="center" bgcolor="#f9fafb" style="padding:20px; font-size:13px; color:#6b7280;">
              ...
              Need help? <a href="{{Support_Link}}" style="color:#dc2626; text-decoration:none;">Contact Support</a>
            </td>
          </tr>
